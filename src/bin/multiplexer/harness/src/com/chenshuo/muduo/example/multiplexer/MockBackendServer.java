...
public class MockBackendServer {
    ...
    private class Handler extends SimpleChannelHandler {
        ...
        public void channelConnected(ChannelHandlerContext ctx, ChannelStateEvent e)
                throws Exception {
            logger.info("channelConnected {}, {}", ctx, e);
        ...
        public void channelDisconnected(ChannelHandlerContext ctx, ChannelStateEvent e)
                throws Exception {
            logger.info("channelDisconnected {}, {}", ctx, e);
        ...
        public void messageReceived(ChannelHandlerContext ctx, MessageEvent e)
                throws Exception {
            logger.info("messageReceived {}, {}", ctx, e);
            assert connection == e.getChannel();
            ...
            logger.info("From {}, '{}'", whichClient, input.toString(Charset.defaultCharset()));
